<?php
$record = array();
$record = $cControllers->ListOne("login", "l_id", $id);// Users->ViewUser($cUsers->id);
...
<table id="Users" class="form-table ui-widget-content ui-corner-all" >
    ...
    <tr class="tr">
        ...
        <td class="td">
            <input name="id" class="name" type="hidden" value="<?php echo $id;?>" />
        </td>
    </tr>
...
<!--<input name="btncancel" class="" type="button" value="Cancel" onclick="link_direct('<?php echo BASE_DIR."controllers/controllers.php?p=viewentries&amp;id=".$cUsers->id."&amp;#profile";?>');" />--> 
