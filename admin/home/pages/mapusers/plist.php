...
<table id="list" class="list-table ui-widget-content ui-corner-all" >
    ...
    <tbody>
<?php
$record = $cControllers->ListAllUsersMappingRecords();
//var_dump($record);
//die('ok');
if (!empty($record)){
    $i = 0;
        ...
        <tr class="tr <?php echo $b;?>">
            ...
            <td class="td <?php echo $bg_row;?> td-center">
                 <?php //if ($cApp->HasPrivilege("P_USER_VIEW")) { ?>    
                    <input name="btnedit" class="view" type="button" value="Edit" onclick="link_direct('<?php echo BASE_DIR."controllers/controllers.php?p=mapusers&id=".$value["u_id"];?>#mapusers');" />
                <?php // } ?>
            </td>
