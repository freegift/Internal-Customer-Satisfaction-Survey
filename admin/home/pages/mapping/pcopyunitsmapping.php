...
<form name="copy" action="" method="POST">
    <input type="hidden" value="copy_units_mapping" name="form" />
    Copy existing units mapping to default survey mapping:
    ...
    &nbsp;&nbsp;&nbsp;<input type="submit" value="Copy Mapping" name="btncopymap" />
</form>
<br>
<?php endif; ?>