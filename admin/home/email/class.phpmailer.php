...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'no-reply@cornerstone.com.ng';// 'root@localhost';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Cornerstone Inventory System';//'Root User';
   ...
   * @var string
   */
  public $Sender            = 'no-reply@cornerstone.com.ng';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'ip-50-63-60-188.ip.secureserver.net';
//'smtp.gmail.com';'mail.cornerstone.com.ng';//'localhost';
   ...
   * @var string
   */
  public $Username      = 'no-reply@cornerstone.com.ng';//'freeg.research@gmail.com';//'';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'pass=123';//'freeg084';//'';
